!function () {
    var t = sessionStorage.getItem("__HYPER_CONFIG__"),
        ...
        i = {
            ...
            topbar: { color: "light" },
            menu: { color: "light" },
            sidenav: { size: "fullscreen", user: !0 }
        },
    ...
    if (config.menu.color = null !== o ? o : i.menu.color,
        ...
        config) {
            ...
            if ("vertical" == config.nav) {
                ...
                window.innerWidth <= 767 ? t = "full" : 767 <= window.innerWidth && window.innerWidth <= 1140 && "full" !== window.config.sidenav.size && "fullscreen" !== window.config.sidenav.size && (t = "condensed"),
